			...
			resBody: []map[string]interface{}{
				{
					...
					"travel_time":  float64(542802),
					"setup_time":   float64(0),
					"service_time": float64(328),
			...
			resBody: []map[string]interface{}{
				{
					...
					"arrival":      "1970-01-01 00:00:00",
					"departure":    "1970-01-01 00:00:00",
					"travel_time":  float64(196347),
					"setup_time":   float64(0),
					"service_time": float64(184),
					"waiting_time": float64(0),
					"load":         []interface{}{},
					"vehicle_data": map[string]interface{}{},
					"task_data":    map[string]interface{}{},
